...
public class MainActivity extends AppCompatActivity {
    ...
    public void destruir(){
        if (mediaPlayer!=null){
            mediaPlayer.release(); //release es liberar
        }
    }
    public void reproducir (View view) {
        ...
        if (radio6.isChecked()){
            ...
            try { //se tiene que agregar try catch debido a que es un archivo remoto y no se sabe si el recurso estaria disponible o no
